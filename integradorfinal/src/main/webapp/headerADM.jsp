...
<body>
	<nav class="nav" id="header">
        ...
        <div class="nav-menu" id="navMenu">
            <ul>
                <li><a href="login.jsp" class="link active">Inicio</a></li>                
                <li><a href="nuevoproducto.jsp" class="link">Agregar Producto</a></li>
                <li><a href="index.jsp" class="link">Nosotros</a></li>
